;
;	Monitor SBC6809GMonitor for Grant's 6809 SBC hardware
;
;	Small monnitor running on the Grant's SBC 6809.
;	ROM size produced 16kB
;
;	Version:	1.0
...
OSStart:			;	Strategic init temporaly Stack pointer
                    ...
                    ;	6809 crystal of 7.3728 Mh => E: 7.3728/4=1.8432Mhz => 1.8432/16=115200 bauds
					...
					andcc	#$A0                        ;   Enable all interrupts IRQ and FIRQ (E F H I N Z V C)
...
STRSystemStart1		fcc	"\033ESBC6809 16kB for Grant's board\015\012\0"
STRSystemStart2		fcc	"Favard L. 2025\015\012\0"
